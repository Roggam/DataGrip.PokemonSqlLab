...
SELECT pokemon_trainer.pokemon_id, COUNT(pokemon_trainer.trainerID)
FROM pokemon_trainer GROUP BY pokemon_trainer.pokemon_id HAVING COUNT(pokemon_trainer.trainerID) = 1;
